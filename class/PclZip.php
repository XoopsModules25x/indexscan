...
class PclZip
{
    ...
    public function privOptionDefaultThreshold(&$p_options)
    {
        ...
        if ('g' === $last) { //$v_memory_limit = $v_memory_limit*1024*1024*1024;
            $v_memory_limit = $v_memory_limit * 1073741824;
        }
        if ('m' === $last) { //$v_memory_limit = $v_memory_limit*1024*1024;
    ...
    public function privFileDescrExpand(&$p_filedescr_list, &$p_options)
    {
        ...
        for ($i = 0, $iMax = count($p_filedescr_list); $i < $iMax; ++$i) {
            ...
            if ('folder' === $v_descr['type']) {
                ...
                $v_dirlist_descr = [];
                $v_dirlist_nb    = 0;
                $v_folderHandler = @opendir($v_descr['filename']);
                if ($v_folderHandler) {
    ...
    */
    ...
    public function privExtractByRule(&$p_file_list, $p_path, $p_remove_path, $p_remove_all_path, &$p_options)
    {
      ...
      */
            ...
            if ($v_extract && (1 == ($v_header['flag'] && 1))) {
    ...
    public function privExtractFile(&$p_entry, $p_path, $p_remove_path, $p_remove_all_path, &$p_options)
    {
        ...
        if ('ok' === $p_entry['status']) {
            ...
            if (file_exists($p_entry['filename'])) {
                ...
                if (1 != ($v_result = $this->privDirCheck($v_dir_to_check, 0x00000010 == ($p_entry['external'] & 0x00000010)))) {
                    // ----- Change the file status
    ...
    // --------------------------------------------------------------------------------
    /**
     * @param $p_local_header
     * @param $p_central_header
     * @return int
     */
