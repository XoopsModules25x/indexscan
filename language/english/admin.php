...
define('_AM_INDEXSCAN_CREATE', 'Create index.php');
...
define('_AM_INDEXSCAN_CREATED', 'index.php created');
define('_AM_INDEXSCAN_CREATEDINDEXFILES', 'index files created');

// Added in 1.01
define(
    '_AM_INDEXSCAN_CHECKFORFILES',
    "<tr class='header'><div style='text-align: center;'><h2>Checking files for IFRAME Infection</h2></tr></div><div style='text-align: center;'><small>Not that not all uses of iFrame is injections.<br>Check the code in the files found before you delete.<br><hr></small></div>"
);
...
define('_AM_INDEXSCAN_INJECTIONSCAN', 'Check iFrame injections');
