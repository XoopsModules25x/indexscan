...
define("_AM_INDEXSCAN_NOTFOUND","Index bestanden <strong>niet</strong> gevonden<br />\n");
define("_AM_INDEXSCAN_FOUNDMISSING","<strong>ontbrekende</strong> index bestanden gevonden\n");
